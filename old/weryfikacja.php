...
function formatBaggageCounts(array $passengers): string
{
    if (empty($passengers)) {
        return '0 sztuk';
    }
    ...
    foreach ($passengers as $index => $passenger) {
        $count = (int)($passenger['baggage_count'] ?? 0);
        $result[] = 'Pasażer ' . ($index + 1) . ': ' . $count . ' szt.';
    }
...
<main class="content">
    <div class="container">
            ...
            <div style="display: flex; justify-content: space-between; gap: 40px; flex-wrap: wrap;">
                    ...
                    <?php foreach ($passengers as $index => $passenger): ?>
                        ...
                        <table class="info-table">
                            ...
                            <tr>
                                ...
                                <td><?php echo e((int)($passenger['baggage_count'] ?? 0)); ?> szt.</td>
                            </tr>
                        </table>
                    <?php endforeach; ?>
                </div>
                ...
                <div>
                    ...
                    <table class="info-table">
                        ...
                        <tr>
                            <th>Telefon</th>
                            <td><?php echo e(($reservation['contact_country'] ?? '') . ' ' . ($reservation['contact_phone'] ?? '')); ?></td>
                        </tr>
                        <tr>
                            <th>Kraj</th>
                            <td><?php echo e($reservation['contact_country'] ?? ''); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <?php if ($departureFlight && $departureData): ?>
                ...
                <div class="plan">
                    <div class="plan-details">
                        ...
                        <div></div>
                        <div>BAGAŻ REJESTROWANY: <?php echo e(formatBaggageCounts($passengers)); ?></div>
                    </div>
        ...
        <a href="index.php?view=edycja_odprawy" class="edytuj">
            Edytuj dane
        </a>
        ...
        <div class="total-section">
            ...
            <a href="index.php?view=wybor_miejsca_odprawa" class="confirm-button">
                POTWIERDŹ DANE*
            </a>
        </div>
