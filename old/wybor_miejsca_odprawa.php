...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['check_in_seat_submit'])) {
    ...
    try {
        ...
        echo '<script>window.location.href = "index.php?view=boarding_pass";</script>';
        return;
...
<main class="content">
    ...
    <div class="price-container check-in-price-container">
        <div class="button-group check-in-button-group">
            <a class="aboard" href="index.php?view=weryfikacja" type="button">Wróć</a>
            <button id="confirmButton" type="button">Dalej</button>
        </div>
    </div>

    <form id="seatSelectionForm" method="post" action="index.php?view=wybor_miejsca_odprawa" style="display:none;">
