      ...
      <div class="flight-container">
        ...
        <form action="index.php" method="post" class="flight-form">
          ...
          <div class="row">
            <div class="date-pair">
              <div class="form-half">
                <input type="text" id="departure-date" name="departure_date" placeholder="Wylot" required onfocus="this.type='date'" onblur="if(!this.value) this.type='text'"/>
              </div>
              <div class="form-half">
                <input type="text" id="return" name="return_date" placeholder="Powrót" required onfocus="this.type='date'" onblur="if(!this.value) this.type='text'"/>
              </div>
            </div>
            <div class="form-group2">
