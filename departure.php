...
<?php if (empty($flights)): ?>
    <main class="content">
        <div class="no-connection-state">
            ...
            <a href="home" class="no-connection-button">Powróć do strony głównej</a>
        </div>
    </main>
<?php else: ?>
    <main class="content">
                ...
                <div class="flight-options">
                    <div class="flight-info">
                        ...
                        <div class="additional-info">
                            ...
                            <p><a href="szczegoly_lotu?id=<?php echo htmlspecialchars($flight['id'] ?? $index); ?>" class="details-link">Sprawdź szczegóły</a></p>
                        </div>
                    </div>
