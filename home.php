...
<!--MAPA-->
<div class="map">
  <img src="img/mapa.png" alt="Mapa połączeń WronAir">
</div>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateReturnVisibility() {
    if (!tripTypeSelect || !returnInputContainer || !departureInputContainer || !returnDateInput) {
      return;
    }
  ...
  function findBestMatch(value, locationList) {
  ...
  if (carousel && prevBtn && nextBtn && indicatorsContainer && tiles.length > 0) {
    ...
    function getTileWidth() {
      ...
      return tiles[0].offsetWidth
        + parseInt(tileStyle.marginLeft, 10)
        + parseInt(tileStyle.marginRight, 10);
    }
